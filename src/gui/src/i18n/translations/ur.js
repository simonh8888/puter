...
const ur = {
  ...
  dictionary: {
    ...
    invalid_link_file: "یہ لنک فائل میں کوئی درست URL نہیں ہے۔",
    invalid_url: "غلط URL۔",
    invalid_url_start: "براہ کرم http:// یا https:// سے شروع ہونے والا درست URL درج کریں۔",
    item: "آئٹم",

...
const ku = {
  ...
  dictionary: {
    ...
    enter_url_prompt: "URL بنووسە:",
    empty_trash: "بەتاڵکردنی تەنەکەی خۆڵ",
    ...
    invite_link: "بەستەری بانگهێشت",
    invalid_link_file: "پەڕگەی بەستەری نادروست.",
    invalid_url: "URL نادروست.",
    invalid_url_start: "URL دەبێت بە http:// یان https:// دەست پێ بکات.",
    item: "بڕگە",

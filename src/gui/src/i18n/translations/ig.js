...
const ig = {
  ...
  dictionary: {
    ...
    invite_link: "Njikọ ọkpụkpọ òkù",
    invalid_link_file: "Faịlụ njikọ ezighi ezi.",
    invalid_url: "URL ezighi ezi.",
    invalid_url_start: "URL ga-amalite site na http:// ma ọ bụ https://.",
    item: "ihe",

...
const vi = {
    ...
    dictionary: {
        ...
        invalid_link_file: "Tệp liên kết này không chứa URL hợp lệ.",
        invalid_url: "URL không hợp lệ.",
        invalid_url_start: "Vui lòng nhập URL hợp lệ bắt đầu bằng http:// hoặc https://.",
        item: 'mục',
